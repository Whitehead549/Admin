...
const TransHash = () => {
  ...
  <div className="w-full max-w-5xl px-4">
    <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-6">TransHash</h1>
      ...
      <table className="hidden md:table w-full text-left border-collapse">
        <thead className="bg-gray-100 border-b border-gray-300">
          <tr>
            ...
            <th className="py-4 px-6 text-sm font-medium text-gray-600">TransHash</th>
        ...
        <tbody>
          {deposits.map((deposit) => (
            <tr key={deposit.id} className="hover:bg-gray-50">
              ...
              <td className="py-4 px-6 text-sm text-gray-800">{deposit.transactionHash}</td>
      ...
      <div className="md:hidden">
        {deposits.map((deposit) => (
          <div key={deposit.id} className="border-b last:border-none p-4">
            ...
            <p className="text-sm text-gray-600">
              <strong>transactionHash:</strong> {deposit.transactionHash}
            </p>
